...
namespace June.Analytics {
	...
	public partial class AnalyticsManager {
			...
			get {
				if(null == _Providers) {
					_Providers = new Dictionary<string, IAnalyticsProvider>() {
						{ ProviderTypes.Flurry, new FlurryProvider() }
					};
		...
		public class Events {
			public static readonly string HomePlayTap = "HomePlayTap";
			public static readonly string ResumeWatchAdTap = "ResumeWatchAdTap";
			public static readonly string RateUsOk = "RateUsOk";
		}

		public static Dictionary<string, Event> EVENTS = new Dictionary<string, Event>() {
			{ Events.HomePlayTap, new Event() { Name=Events.HomePlayTap, Parameters=new string[] { "" }, Providers=new string[] { "Flurry" }, SubscribedMessage="//home/play_tap" } },
			{ Events.ResumeWatchAdTap, new Event() { Name=Events.ResumeWatchAdTap, Parameters=new string[] { "" }, Providers=new string[] { "Flurry" }, SubscribedMessage="//game_over/watch_ad_tap" } },
			{ Events.RateUsOk, new Event() { Name=Events.RateUsOk, Parameters=new string[] { "" }, Providers=new string[] { "Flurry" }, SubscribedMessage="//rate_us/ok_tap" } }
		};
