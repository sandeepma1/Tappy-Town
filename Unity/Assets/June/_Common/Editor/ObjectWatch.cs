...
public class ObjectWatch : EditorWindow {
	...
	public static Assembly GetAssembly() {
		if(null == _Assembly) {
			_Assembly = typeof(GameEventManager).Assembly;
		}
		return _Assembly;
	}
	...
	public static PropertyInfo[] GetProperties(Type type) {
		if(null != type && null != type.BaseType && type.BaseType.IsGenericType && type.BaseType.Name.Contains("BaseConfig")) {
			return type.BaseType.GetProperties();
		}
