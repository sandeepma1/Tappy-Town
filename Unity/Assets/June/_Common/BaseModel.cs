...
namespace June.Core {
	...
	public virtual string Id {
		get {
			return GetString(Schema.BaseSchema.Id);
		}
	}
	...
	public partial class BaseList<T> : IBaseList<IRecordArray, IRecord, T> where T : BaseModel {
		...
		public static List<T> GetListFromArray(IRecordArray array, Converter<IRecord, T> ctor) {
			return GetListFromArray(array, ctor);
		}
	}
	#endregion
}