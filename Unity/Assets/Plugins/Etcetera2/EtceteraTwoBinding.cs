...
namespace Prime31
{
	public class EtceteraTwoBinding
	{
		...
		[DllImport("__Internal")]
		private static extern void _etceteraTwoRegisterForNotifications();

		// Registers for notifications. On iOS 8+ it is required ot register for notifications before local notifications can be used
		public static void registerForNotifications()
		{
			if( Application.platform == RuntimePlatform.IPhonePlayer )
				_etceteraTwoRegisterForNotifications();
		}
